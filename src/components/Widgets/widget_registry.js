...
export { default as TaskSidebarWidget } from './TaskSidebarWidget/TaskSidebarWidget'
export { default as TaskMapWidget } from './TaskMapWidget/TaskMapWidget'
export { default as ChallengeNameWidget } from './ChallengeNameWidget/ChallengeNameWidget'
export { default as TaskInstructionsWidget } from './TaskInstructionsWidget/TaskInstructionsWidget'
export { default as TaskCommentsWidget } from './TaskCommentsWidget/TaskCommentsWidget'
